...
| 12 | Telemetry: ChannelJob sets gen_ai.conversation.id = Session ID on shrimp.job span via AiSdkShrimpAgent; HeartbeatJob omits it | done | pending | pending | TBD; +3 test cases (ChannelJob/HeartbeatJob/shrimp.job.id); 451/451 pass |
