...
| Contract      | Description                                                                                                                                                                                                                |
| ------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Input         | Assembled system prompt, assembled user prompt, the full available tool set (Built-in + MCP), and the Job ID (`jobId: string`) generated by the Job Worker for this invocation                                             |
